defmodule Mimo.ProceduralStore.ExecutionFSMTest do
  ...
  describe "procedure execution" do
    test "executes deterministic steps without LLM" do
      ...
      # Start procedure
      {:ok, _pid} =
        ExecutionFSM.start_procedure("test_procedure", "1.0", %{"input" => "test"}, caller: self())
    ...
    test "handles validation errors" do
      ...
      {:ok, _pid} = ExecutionFSM.start_procedure("validation_test", "1.0", %{}, caller: self())
    ...
    test "supports conditional branching" do
      ...
      {:ok, _} =
        ExecutionFSM.start_procedure("conditional_test", "1.0", %{"value" => 10}, caller: self())
      ...
      # Test with low value
      {:ok, _} =
        ExecutionFSM.start_procedure("conditional_test", "1.0", %{"value" => 3}, caller: self())
