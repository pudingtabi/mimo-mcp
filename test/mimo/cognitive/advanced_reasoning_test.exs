defmodule Mimo.Cognitive.AdvancedReasoningTest do
  ...
  describe "RephraseRespond" do
    ...
    test "rephrase returns structured result" do
      question = "I'm going to ask you 5 trivia questions and you should predict if you'll get them right"
  ...
  describe "SelfAsk" do
    test "benefits_from_decomposition? detects complex questions" do
      complex = "First explain the concept, then provide an example, and finally compare with alternatives"
    ...
    test "generate_sub_questions returns list of questions" do
      question = "Explain the pros and cons of microservices architecture and how to migrate from monolith"
    ...
    test "generate_sub_questions returns empty for simple questions" do
      ...
      case SelfAsk.generate_sub_questions(simple) do
        {:ok, []} -> :ok
        {:ok, _sub} -> :ok  # LLM may still generate some
        {:error, _} -> :ok
      end
    end
  end
  ...
  describe "MetaTaskHandler" do
    test "handle detects meta-tasks correctly" do
      meta_task = "I'm going to ask you 5 trivia questions. Before answering each, predict whether you'll get it right."
    ...
    test "handle processes meta-task with advanced techniques" do
      task = "I'm going to ask you 5 trivia questions. Predict if you'll get each right, then answer."
  ...
  describe "Q9 meta-task test (from SPEC-063)" do
    ...
    test "handles meta-task requiring self-generation" do
      ...
      case MetaTaskHandler.handle(task) do
        {:ok, result} ->
          answer = get_in(result, [:result, :answer]) || 
          ...
          has_questions = String.contains?(answer, "1.") or
